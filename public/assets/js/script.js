$(function() {
	...
	// The server will either grant or deny access, depending on the secret ke

	socket.on('data-change',function(){
	...
	socket.emit('hello',{ user: document.getElementById("user").value});	
